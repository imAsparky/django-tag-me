...
Get Started! (Below here is not yet implemented. Coming soon.)
--------------------------------------------------------------
...
1. Fork the `django-tag-me` repo on GitHub.
...
3. Assuming you have virtualenv installed (If you have Python 3.6 this should
   ...
   .. code-block:: bash
        ...
        $ virtualenv django-tag-me-env
        $ source django-tag-me-env/bin/activate
...
6. The next step would be to run the test cases. `django-tag-me` uses
...
.. cookiecutter: https://github.com/imAsparky/django-tag-me
